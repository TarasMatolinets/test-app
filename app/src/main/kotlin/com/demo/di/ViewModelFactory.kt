...
class ViewModelFactory constructor(private val viewModels: Map<Class<out ViewModel>, Provider<ViewModel>>) : Factory {
    ...
    private fun <T : ViewModel> getProvider(modelClass: Class<T>): Provider<T> =
        try {
            ...
            error("Wrong provider name registered for ViewModel name $modelClass")
        }
}